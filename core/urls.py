...
urlpatterns = [
    ...
    path('reset/done/', 
         auth_views.PasswordResetCompleteView.as_view(template_name='landing/password_reset_complete.html'), 
    ...
    path('donor-dashboard/sponsorship/<int:sponsorship_id>/checkout/', views.pay_checkout, name='pay_checkout'),
